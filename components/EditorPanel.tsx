...
const EditorPanel: React.FC<EditorPanelProps> = ({
  ...
  const themes: { id: CardTheme; label: string }[] = [
    ...
    { id: 'wood-ebony', label: '에보니' },
    { id: 'metal-steel', label: '스틸' },
    { id: 'pop-retro', label: '팝레트로' },
    { id: 'liquid-gold', label: '리퀴드골드' },
    { id: 'stark', label: '스타크' },
    ...
    { id: 'abstract-paint', label: '추상화' },
    { id: 'minimalist-warm', label: '웜미니멀' },
    { id: 'neon-vibe', label: '네온바이브' },
    { id: 'blueprint-red', label: '레드블루프린트' },
    { id: 'ink-wash', label: '수묵화' },
    { id: 'glam-gold', label: '글램골드' },
    { id: 'cyber-pulse', label: '사이버펄스' },
    { id: 'desert-sand', label: '데저트샌드' },
    { id: 'aurora-borealis', label: '오로라' },
    { id: 'minimalist-dark-red', label: '다크레드' },
    { id: 'patchwork', label: '패치워크' },
    { id: 'monochrome-bold', label: '모노크롬볼드' },
    { id: 'futuristic-white', label: '퓨처화이트' },
    { id: 'pixel-city', label: '픽셀시티' },
    { id: 'warm-wood-grain', label: '웜우드' },
    { id: 'frosted-mint', label: '프로스티드민트' },
    { id: 'deep-crimson', label: '딥크림슨' },
    { id: 'charcoal-sketch', label: '차콜스케치' },
    { id: 'electric-blue', label: '일렉트릭블루' },
    { id: 'vintage-travel', label: '빈티지트래블' },
    { id: 'pastel-dreams', label: '파스텔드림' },
    { id: 'modern-art-deco', label: '모던아르데코' },
    { id: 'brutalist-color', label: '브루탈리스트컬러' },
    { id: 'eco-friendly', label: '에코프렌들리' },
    { id: 'retro-future', label: '레트로퓨처' },
    { id: 'dark-botanical', label: '다크보타니컬' },
    { id: 'stucco-white', label: '스터코화이트' },
    { id: 'indigo-dye', label: '인디고다이' },
    { id: 'copper-plate', label: '코퍼플레이트' },
    { id: 'minimalist-teal', label: '미니멀티알' },
    { id: 'cyberpunk-red', label: '사이버펑크레드' },
    { id: 'arctic-white', label: '아틱화이트' },
    { id: 'desert-oasis', label: '오아시스' },
    { id: 'volcanic-ash', label: '볼케이닉애쉬' },
    { id: 'deep-sea-pearl', label: '딥씨펄' },
    { id: 'celestial-gold', label: '셀레스티얼골드' },
    { id: 'urban-industrial', label: '어반인더스트리얼' },
    { id: 'vintage-typewriter-ink', label: '빈티지잉크' },
    { id: 'minimalist-zen-stone', label: '젠스톤' },
    { id: 'neon-cyber-pulse', label: '네온사이버' },
    { id: 'forest-canopy', label: '포레스트캐노피' },
    { id: 'marble-obsidian', label: '마블오닉스' },
    { id: 'tech-grid-blue', label: '테크블루' },
    { id: 'organic-terra', label: '오가닉테라' },
    { id: 'futuristic-glass', label: '퓨처글래스' },
    { id: 'retro-cassette-tape', label: '레트로카세트' },
    { id: 'luxury-velvet-gold', label: '벨벳골드' },
    { id: 'geometric-vivid', label: '지오메트릭비비드' },
    { id: 'pop-vibrant', label: '팝바이브런트' },
    { id: 'blueprint-white', label: '도면화이트' },
    { id: 'newspaper-classic', label: '클래식신문' },
    { id: 'sketch-charcoal-pro', label: '차콜프로' },
    { id: 'brutalist-raw', label: '브루탈리스트로우' },
    { id: 'pastel-soft-glow', label: '소프트글로우' },
    { id: 'architect-monochrome', label: '아키텍트모노' },
    { id: 'comic-action', label: '코믹액션' },
    { id: 'midnight-constellation', label: '미드나잇별자리' },
    { id: 'vintage-newspaper-ads', label: '신문광고' },
    { id: 'pixel-adventure', label: '픽셀어드벤처' },
    { id: 'bento-clean-cut', label: '벤토클린' },
  ];
